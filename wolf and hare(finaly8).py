...
def setPosition(table, screen):
    ...
    for j in range(10):
        for i in range(10):
            ...
            if table[j][i] // 10 >= 1 and table[j][i] < 100 :
                for k in range(table[j][i] // 10):
                    d = pygame.Rect(5+i*71.5+random.randint(0,67-45),5+j*71.5+random.randint(0,67-45), 45, 45)
                    pygame.draw.rect(screen, (0,0,255), d, 5)
            elif table[j][i] > 100:
                for k in range(table[j][i] // 100):
                    d = pygame.Rect(5+i*71.5+random.randint(0,67-45),5+j*71.5+random.randint(0,67-45), 45, 45)
                    pygame.draw.rect(screen, (0,0,255), d, 5)
